# ------------------------------------------------------------
# Instagram Info API — Credit: Mahedi Hasan Rifat (@rifatfanz)
# JOIN    : @rifatfanz FOR MORE SRC | API | BOT CODE | METHOD | 🛐
# Purpose : Fetch profile & recent media (public + optional session-based)
# Note    : THIS CODE MADE BY MAHEDI HASAN RIFAT @rifatfanz (GIVE CREDIT OTHERWISE EVERYONE FUCK YOU AT 300 KM SPEED)
